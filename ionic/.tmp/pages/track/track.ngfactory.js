...
var renderType_TrackPage_Host = null;
var _View_TrackPage_Host0 = (function (_super) {
    __extends(_View_TrackPage_Host0, _super);
    function _View_TrackPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_TrackPage_Host0, renderType_TrackPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_TrackPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('ng-component', rootSelector, null);
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_TrackPage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._TrackPage_0_4 = new import3.TrackPage(this.parentInjector.get(import8.AuthService));
        this._appEl_0.initComponent(this._TrackPage_0_4, [], compView_0);
        compView_0.create(this._TrackPage_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_TrackPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.TrackPage) && (0 === requestNodeIndex))) {
            return this._TrackPage_0_4;
        }
        return notFoundResult;
    };
    return _View_TrackPage_Host0;
}(import1.AppView));
function viewFactory_TrackPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_TrackPage_Host === null)) {
        (renderType_TrackPage_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_TrackPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var TrackPageNgFactory = new import10.ComponentFactory('ng-component', viewFactory_TrackPage_Host0, import3.TrackPage);
var styles_TrackPage = [];
var renderType_TrackPage = null;
var _View_TrackPage0 = (function (_super) {
    __extends(_View_TrackPage0, _super);
    function _View_TrackPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_TrackPage0, renderType_TrackPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_TrackPage0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_16 = import32.viewFactory_Item0(this.viewUtils, this.injector(16), this._appEl_16);
        this._Item_16_4 = new import16.Item(this.parentInjector.get(import33.Form), this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_16), this.renderer);
    ...
    _View_TrackPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_TrackPage0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_TrackPage0.prototype.destroyInternal = function () {
        this._Icon_18_3.ngOnDestroy();
        this._Content_9_4.ngOnDestroy();
    };
    return _View_TrackPage0;
}(import1.AppView));
export function viewFactory_TrackPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_TrackPage === null)) {
        (renderType_TrackPage = viewUtils.createRenderComponentType('/Users/kevinisaza/node/ec0/ionic/.tmp/pages/track/track.html', 0, import9.ViewEncapsulation.None, styles_TrackPage, {}));
    }
    return new _View_TrackPage0(viewUtils, parentInjector, declarationEl);
}
