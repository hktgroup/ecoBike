...
var _View_TabsPage0 = (function (_super) {
    ...
    _View_TabsPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_5 = this.context.tab3Root;
        ...
        var currVal_10 = this.context.tab2Root;
...
export function viewFactory_TabsPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_TabsPage === null)) {
        (renderType_TabsPage = viewUtils.createRenderComponentType('/Users/kevinisaza/node/ec0/ionic/.tmp/pages/tabs/tabs.html', 0, import9.ViewEncapsulation.None, styles_TabsPage, {}));
    }
